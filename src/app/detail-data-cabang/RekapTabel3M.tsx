...
const RekapTabel3M = () => {
  ...
  const endpointMap: Record<string, string> = {
    ...
    "LOKET PERWAKILAN SURAKARTA": "lokprwsra",
    "SAMSAT SURAKARTA": "samsatsurakarta",
    "SAMSAT KLATEN": "samsatklaten",
    "SAMSAT BOYOLALI": "samsatboyolali",
    "SAMSAT SRAGEN": "samsatsragen",
    "SAMSAT PRAMBANAN": "samsatprambanan",
    "SAMSAT DELANGGU": "samsatdelanggu",
    "LOKET PERWAKILAN MAGELANG": "lokprwmgl",
    "SAMSAT MAGELANG": "samsatmagelang",
    "SAMSAT PURWOREJO": "samsatpurworejo",
    "SAMSAT KEBUMEN": "samsatkebumen",
    "SAMSAT TEMANGGUNG": "samsattemanggung",
    "SAMSAT WONOSOBO": "samsatwonosobo",
    "SAMSAT MUNGKID": "samsatmungkid",
    "SAMSAT BAGELEN": "samsatbagelen",
    "LOKET PERWAKILAN PURWOKERTO": "lokprwpwt",
    "SAMSAT PURWOKERTO": "samsatpurwokerto",
    "SAMSAT PURBALINGGA": "samsatpurbalingga",
    "SAMSAT BANJARNEGARA": "samsatbanjarnegara",
    "SAMSAT MAJENANG": "samsatmajenang",
    "SAMSAT CILACAP": "samsatcilacap",
    "SAMSAT WANGON": "samsatwangon",
    "LOKET PERWAKILAN PEKALONGAN": "lokprwpkl",
    "SAMSAT PEKALONGAN": "samsatpekalongan",
    "SAMSAT PEMALANG": "samsatpemalang",
    "SAMSAT TEGAL": "samsattegal",
    "SAMSAT BREBES": "samsatbrebes",
    "SAMSAT BATANG": "samsatbatang",
    "SAMSAT KAJEN": "samsatkajen",
    "SAMSAT SLAWI": "samsatslawi",
    "SAMSAT BUMAYU": "samsatbumayu",
    "SAMSAT TANJUNG": "samsattanjung",
    "LOKET PERWAKILAN PATI": "lokprwpti",
    "SAMSAT PATI": "samsatpati",
    "SAMSAT KUDUS": "samsatkudus",
    "SAMSAT JEPARA": "samsatjepara",
    "SAMSAT REMBANG": "samsatrembang",
    "SAMSAT BLORA": "samsatblora",
    "SAMSAT CEPU": "samsatcepu",
    "LOKET PERWAKILAN SEMARANG": "lokprwsmg",
    "SAMSAT SEMARANG I": "samsatsemarang1",
    "SAMSAT SEMARANG II": "samsatsemarang2",
    "SAMSAT SEMARANG III": "samsatsemarang3",
    "LOKET PERWAKILAN SUKOHARIO": "lokprwskh",
    "SAMSAT SUKOHARIO": "samsatsukohario",
    "SAMSAT KARANGANYAR": "samsatkaranganyar",
    "SAMSAT WONOGIRI": "samsatwonogiri",
    "SAMSAT PURWANTORO": "samsatpurwantoro",
    "SAMSAT BATURETNO": "samsatbaturetno",
  };
